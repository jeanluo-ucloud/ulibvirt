...
typedef enum {
    ...
    /*
     * Keep the VM in the paused state on the source host when the migration
     * has finished.
     */
    VIR_MIGRATE_PAUSED_SOURCE     = (1 << 17),

    /*
     * Migrate to localhost, to support live upgrade qemu.
     */
    VIR_MIGRATE_LOCALHOST         = (1 << 31),
