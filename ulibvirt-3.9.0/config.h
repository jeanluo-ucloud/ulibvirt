...
#define BROKEN_GCC_WLOGICALOP_STRCHR 1
...
/* Define to 1 if you have the declaration of `ETHTOOL_GFEATURES', and to 0 if
   you don't. */
#define HAVE_DECL_ETHTOOL_GFEATURES 0
...
/* Define to 1 if you have the declaration of `ETH_FLAG_TXVLAN', and to 0 if
   you don't. */
#define HAVE_DECL_ETH_FLAG_TXVLAN 0
...
#define IP6TABLES_PATH "/usr/local/sbin/ip6tables"

/* path to iptables binary */
#define IPTABLES_PATH "/usr/local/sbin/iptables"
...
#define PACKAGE_STRING "libvirt 3.9.0"
